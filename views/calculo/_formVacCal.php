...
<div class="calculo-form">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            echo Html::textInput('fec_inicio', '', ['id' => 'fec_inicio', 'class' => 'form-control','readonly'=>'readonly']);

            echo Html::label('Fecha Fin del Período a Calcular');

            echo Html::textInput('fec_fin', '', ['id' => 'fec_fin', 'class' => 'form-control']);

            echo Html::label('Año de Cálculo');
        ...
        <div class="col-lg-4">
            ...
            echo Html::label('Días calculados por ley (incluye antiguedad)');
            echo Html::textInput('dias_cal_cal', '', ['id' => 'dias_cal_cal', 'class' => 'form-control', 'readonly' => 'readonly']);

            echo Html::label('Saldo Anterior (Calendario)');
            ...
            echo Html::label('Dias Generados Calendario; aqui debe ir total total de vacaciones calduladas');
...
<?php
$url = Url::base() . '@web/js/formVacCal.js';
